...
const Cart = () => {
  ...
  return (
    <main
      ref={containerRef}
      className="w-full min-h-screen pt-32 pb-20 px-6 lg:px-12 bg-[#f8f8f8] text-[#1a1a1a]"
    >
      <div className="max-w-[1400px] mx-auto">
        <header className="mb-12 border-b border-black/10 pb-6 flex items-end justify-between">
          <h1 className="text-3xl lg:text-4xl font-light tracking-widest uppercase">
            Your Cart
          </h1>
        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
              ...
              return (
                ...
                >
                  <Link
                    ...
                    className="w-24 h-32 lg:w-32 lg:h-40 shrink-0 overflow-hidden bg-[#f0f0f0]"
                  >
                    <img
                  ...
                  <div className="flex flex-col justify-between flex-1 py-1">
                    <div className="flex justify-between items-start gap-4">
                      <div>
                        <Link
                          to={`/product/${item.slug}`}
                          className="text-sm lg:text-base font-medium tracking-wide hover:opacity-70 transition-opacity"
                        >
                          {item.title}
                        </Link>
                    ...
                    <div className="flex items-center justify-between mt-4">
                      <div
                        className={`flex items-center border border-black/10 w-24 lg:w-28 h-10 transition-opacity ${isItemVerifying ? "opacity-50 pointer-events-none" : ""}`}
                      >
                        <button
          ...
          <div className="cart-summary w-full lg:w-[35%]">
            <div className="bg-white p-8 border border-black/5 lg:sticky lg:top-32">
              <h2 className="text-sm uppercase tracking-widest font-bold mb-8">
                Order Summary
              </h2>
              ...
              <div className="flex flex-col gap-4 text-sm mb-8 border-b border-black/10 pb-8">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[0.65rem] uppercase tracking-widest opacity-50 mt-0.5">
