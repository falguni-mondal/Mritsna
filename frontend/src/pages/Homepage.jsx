...
const Homepage = () => {
  return (
    <div className="w-full" id="homepage">
      <section
        className="w-full h-[100dvh] relative flex flex-col lg:flex-row justify-between pt-20 lg:pt-0 px-3 lg:px-48 txt-light"
        id="home-hero"
      >
        <div className="hero-left flex flex-col justify-center">
          ...
          <div className="hero-subheading text-sm w-full lg:w-[50ch] mb-6">
          ...
          <div className="hero-button uppercase">
            ...
            >
              ...
              <span className="flex items-center gap-1 text-[0.6rem] lg:text-[0.7rem] tracking-wider font-medium">explore now <Icon className="text-sm" icon="iconamoon:arrow-right-1" /> </span>
              {/* <span className="inline-flex py-6 w-1.5 border-y border-r rounded-[1.5px]"></span> */}
            </Link>
          </div>
        </div>

        <div className="hero-right flex flex-col lg:items-end justify-end mb-5">
          <h2 className="uppercase mb-1 text-[0.6rem] lg:text-[0.7rem] tracking-wider">Exclusive of this month.</h2>
          <div className="hero-product-wrapper flex flex-col items-end justify-end bg-[linear-gradient(90deg,rgba(248,248,248,0.15)_0%,rgba(170,170,170,0.10)_50%,rgba(0,0,0,0.05)_100%)] rounded-md p-px">
            <Link
              to="/"
              className="hero-product w-full lg:w-96 flex gap-3 lg:flex-col lg:gap-0 p-2 lg:p-5 backdrop-blur-3xl rounded-md"
            >
              <div
                className="w-1/3 lg:w-full aspect-square rounded-md overflow-hidden"
                id="hero-product-img"
              >
                <img
              ...
              <div className="hero-prod-desc w-2/3 flex flex-col justify-between lg:w-full mt-3">
                <div className="product-category uppercase text-[0.6rem] lg:text-[0.7rem] tracking-wider">
                  Decorative Base
                </div>
                <div className="hero-prod-heading flex justify-between items-center">
                  <h2 className="product-name text-xl lg:text-2xl head-font">
                    Alpha Product
                  </h2>
                  <div className="hero-prod-rating h-fit flex gap-1">
                    <span className="inline-flex py-2 w-1 border-y border-l rounded-[1.5px]"></span>
                    <div className="flex items-center gap-1 text-[0.6rem] lg:text-xs leading-none">
                ...
                <div className="hero-prod-price px-5 lg:px-10 py-2 lg:py-3 border w-fit lg:mt-5 text-sm lg:text-base">
                  ₹ 140.00
                </div>
              </div>
            </Link>
